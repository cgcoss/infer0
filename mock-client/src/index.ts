...
<p>A third-party app powered by <a href="https://infer0.cgcoss.workers.dev" target="_blank">infer0</a>.</p>
...
signInBtn.addEventListener('click', () => {
  ...
  window.location.href = 'https://infer0.cgcoss.workers.dev/oauth/authorize?client_id=' + encodeURIComponent(clientId) + '&redirect_uri=' + encodeURIComponent(redirectUri) + '&response_type=code';
});
