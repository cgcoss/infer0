...
<h1>Acme <span>Chat</span></h1>
    ...
    <p style="font-size:0.75rem;color:var(--text-muted);margin-top:-20px;margin-bottom:24px">Using <strong>raw fetch</strong> — try <a href="/sdk" style="color:var(--accent)">SDK mode</a></p>
...
<p style="font-size:0.75rem;color:var(--text-muted);margin-top:-20px;margin-bottom:24px">Using <strong>OpenAI SDK</strong> — back to <a href="/" style="color:var(--accent)">raw fetch</a></p>
